...
var Tetrimino, TetriminoRed, TetriminoYellow, idNumber,
...
TetriminoYellow = (function(superClass) {
  extend(TetriminoYellow, superClass);

  function TetriminoYellow(args) {
    TetriminoYellow.__super__.constructor.call(this, [0, 0, 0, 30, 30, 0, 30, 30], "yellow");
    this.deg["deg90"] = [0, 0, 0, 30, 30, 0, 30, 30];
    this.deg["deg180"] = [0, 0, 0, 30, 30, 0, 30, 30];
    this.deg["deg270"] = [0, 0, 0, 30, 30, 0, 30, 30];
  }

  return TetriminoYellow;
